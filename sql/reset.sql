-- ============================================================
-- 艺术培训机构全流程教务管理平台 - 数据库一键重置（完整版）
-- 用途：删除旧库 → 建表 → 填充全部演示数据，一步到位
-- 使用方法：
--   PowerShell: Get-Content sql\reset.sql | mysql -uroot -p123456
--   Bash:       mysql -uroot -p123456 < sql/reset.sql
-- 内容：自动从 schema.sql + data.sql 生成
-- 版本：v1.0
-- 更新：2026-07-21 数据驱动菜单改造 + 大课表菜单补全
-- ============================================================
...
CREATE TABLE `notification` (
  ...
  type VARCHAR(32) NOT NULL COMMENT 'SCHEDULE_CHANGE|CLASS_REMINDER|EXAM_NOTICE|ANNOUNCEMENT',
  title VARCHAR(200) NOT NULL,
  content VARCHAR(500),
...
(25, 3, '大课表',   NULL, '/edu/big-schedule','menu:big-schedule', 5),
(16, 3, '排课管理', NULL, '/edu/schedules',   'menu:schedule',   6),
(17, 3, '教室管理', NULL, '/edu/classrooms',  'menu:classroom',  7),
(18, 3, '考勤管理', NULL, '/edu/attendances', 'menu:attendance', 8),
(19, 3, '考级管理', NULL, '/edu/exams',       'menu:exam',       9),
-- 财务管理子菜单
