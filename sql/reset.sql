...
-- 内容：本文件 = resetHeader + schema.sql + data.sql 三合一
-- 版本：v0.9
-- 更新：2026-07-17 添加 user.version 列，与实体 @Version 保持一致
-- ============================================================
...
(2,  'enrollment', '审核通过报名（学员=黄思源，课程=硬笔书法班，id=4）', '192.168.1.101','2026-07-09 09:00:00'),
(12, 'enrollment', '审核通过报名（学员=吴俊杰，课程=钢琴考级一对一，id=6）', '192.168.1.102','2026-07-09 09:30:00'),
(13, 'enrollment', '审核通过报名（学员=刘子轩，课程=朗诵表演班，id=12）', '192.168.1.103','2026-07-09 10:00:00'),
(3,  'finance',   '收费确认（学员=刘小小，金额=2400.00）', '192.168.1.104', '2026-07-08 10:00:00'),
(14, 'finance',   '收费确认（学员=周雨彤，金额=2000.00）', '192.168.1.105', '2026-07-09 09:30:00'),
(15, 'finance',   '收费确认（学员=郑悦然，金额=2800.00）', '192.168.1.106', '2026-07-10 09:00:00'),
