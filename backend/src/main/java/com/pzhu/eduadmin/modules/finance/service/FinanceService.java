...
public interface FinanceService {
    ...
    // 收费
    Page<PaymentRecord> pagePaymentRecords(int pageNum, int pageSize);

    PaymentRecord createPayment(PaymentRecord record);

    // 退费
    Page<RefundRecord> pageRefundRecords(int pageNum, int pageSize);
    ...
    // 课时账户
    Page<LessonAccount> pageLessonAccounts(int pageNum, int pageSize);
    ...
    // 课时流水
    Page<LessonFlow> pageLessonFlows(int pageNum, int pageSize);
